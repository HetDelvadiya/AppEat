...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.placeOrder.setOnClickListener{
            ...
            if (name.isBlank() && address.isBlank() && phoneNumber.isBlank()){
                Toast.makeText(this@PayOutActivity ,"Please Fill All Details" , Toast.LENGTH_SHORT ).show()
            }else{
                placeOrder()
            }
    ...
    private fun placeOrder() {
        ...
        val orderDetails = OrderDetails(userId , name , foodItemName , foodItemPrice , foodItemImage , foodItemQuantities , address , phoneNumber , totalAmount, time , itemPushKey , false ,false)
    ...
    private fun removeItemFromCart() {
        val cartItemsReferencce = databaseReference.child("user").child(userId).child("CartItem")
        cartItemsReferencce.removeValue()
    }
            ...
            userReference.addListenerForSingleValueEvent(object : ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()){
                        ...
                        val phoneNumbers = snapshot.child("phoneNumber").getValue(String::class.java)?:""
                        val totalAmounts = snapshot.child("totalAmount").getValue(String::class.java)?:""
